...
Board.create({title: "Taxes", user_id: 2})
Board.create({title: "Creativity", user_id: 3})
Board.create({title: "Workspace", user_id: 4})
Board.create({title: "RentStuff", user_id: 5})
Board.create({title: "Loans", user_id: 6})
